...
import 'package:sajilobihe_event_venue_booking_system/features/auth/data/data_source/remote_datasource/venue_remote_datasource.dart';
...
import 'package:sajilobihe_event_venue_booking_system/features/dashboard1/Bottom_Screen/view_model/venue_bloc.dart';
import 'package:sajilobihe_event_venue_booking_system/features/dashboard1/Bottom_Screen/view_model/venue_event.dart';
import 'package:sajilobihe_event_venue_booking_system/features/dashboard1/Bottom_Screen/view_model/venue_state.dart';
          ...
          children: [
            ClipRRect(
              ...
              child: imageUrl.contains("assets")
                  ...
                  : Image.network(imageUrl, height: 180, width: double.infinity, fit: BoxFit.cover, errorBuilder: (context, error, stackTrace) {
                      return Image.asset("assets/images/no_image.png", height: 180, width: double.infinity, fit: BoxFit.cover);
                    }),
            ),
            ...
            Row(
              ...
              children: [
                Text("Room: ${venue.capacity}", style: const TextStyle(fontWeight: FontWeight.w500)),
                Text("Price: \$${venue.price.toStringAsFixed(2)} / Night", style: const TextStyle(fontWeight: FontWeight.w500, color: Colors.blue)),
              ],
            ),
            const SizedBox(height: 10),
            Text(venue.description, maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.black54)),
          ],
        ),
      ),
    );
